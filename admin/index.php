...
<div class="container">
    <a style="margin-bottom: 30px;display: block;width: 150px;padding: 5px; text-align: center;border-radius: 5px ; background: #000; color: #fff;text-decoration: none" href="/admin/create.php">Создать фильм</a>
    ...
    <table class="table table-hover">
        ...
        <? while($res = mysqli_fetch_assoc($result)){
            ...
            <tr>
                ...
                <td>'.$res['director'].'</td>
                <td>'.$res['price'].'</td>
                <td><a href="/admin/update.php?id='.$res['id'].'&name='.$res['name'].'">Редактировать</a></td>
                <td><a href="/php/delete.php?id='.$res['id'].'&name='.$res['name'].'">Удалить</a></td>
            </tr>';
